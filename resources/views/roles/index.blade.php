                    ...
                    <div class="table-responsive mt-4">
                        <table class="table mb-0 text-nowrap varient-table align-middle fs-3">
                            ...
                            <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-0">
                                            ...
                                            <button type="button" class="btn btn-danger btn-sm"
                                                onclick="hapusRole('{{ $role->id }}')">Hapus</button>

                                            <form id="form-hapus-{{ $role->id }}"
                                ...
                                @empty
                                    <tr>
                                        <td colspan="8" class="text-center">Belum ada role.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
        ...
        function hapusRole(roleId) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    document.getElementById('form-hapus-' + roleId).submit();
                }
            });
        }
    </script>
